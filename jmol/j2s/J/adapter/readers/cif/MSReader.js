...
this.setModulationForStructure (this.cr.atomSetCollection.getCurrentAtomSetIndex (), isPost);
...
var ok = true;
var ss3 = this.htSubsystems.get ("3");
if (ss3 != null) {
pt.setT (ptc);
ss3.getSymmetry ().toFractional (pt, true);
if (pt.x < 0 || pt.y < 0 || pt.z != 1) ok = false;
}if (ok) {
...
var t = this.cr.atomSetCollection.addRotatedTensor (a, symmetry.getTensor (a.anisoBorU), iop, false, symmetry);
t.isModulated = true;
if (J.util.Logger.debuggingHigh) {
...
var atoms = ac.getAtoms ();
var pt =  new JU.P3 ();
if (bs == null) bs = ac.bsAtoms = J.util.BSUtil.newBitSet2 (0, ac.getAtomCount ());
...
if (!ac.isWithinCell (3, pt, this.minXYZ0.x, this.maxXYZ0.x, this.minXYZ0.y, this.maxXYZ0.y, this.minXYZ0.z, this.maxXYZ0.z, 0.001)) bs.clear (i);
}
}, $fz.isPrivate = true, $fz));
