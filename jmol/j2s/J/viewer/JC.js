...
return "J." + (isRenderer ? "render" : "shape") + (shapeID >= 9 && shapeID < 16 ? "bio." : shapeID >= 16 && shapeID < 24 ? "special." : shapeID >= 24 && shapeID < 29 ? "surface." : ".") + J.viewer.JC.shapeClassBases[shapeID];
}, "~N,~B");
